...
char * sds_clast_pprint(char const* foo, struct clast_stmt *root, int indent, CloogOptions *options);

char * sll_pprint(char const* s, struct clast_stmt *root, int indent, CloogOptions *options);
